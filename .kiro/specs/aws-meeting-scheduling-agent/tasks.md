...
- [ ] 2.1 Create CoreStack with DynamoDB tables, KMS keys, and Cognito
...
- [ ] 2.2 Create ApiStack with API Gateway and Lambda functions
...
- [ ] 2.3 Create WebStack with S3 and CloudFront
